...
public class ThankYouPayment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_thank_you_payment);
    ...
    private void delivery_address(){
        RequestQueue requestQueue = Volley.newRequestQueue(ThankYouPayment.this);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(ThankYouPayment.this, OrderPage.class);
