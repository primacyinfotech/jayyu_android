...
public class AssignPatient extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        assign_patient_list = findViewById(R.id.assign_patient_list);
        assign_patient_btn = findViewById(R.id.assign_patient_btn);
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, patient_list_url,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        // error
                        Toast.makeText(AssignPatient.this, "Something Went Wrong!", Toast.LENGTH_SHORT).show();
                    }
                }
        ) {
            @Override
