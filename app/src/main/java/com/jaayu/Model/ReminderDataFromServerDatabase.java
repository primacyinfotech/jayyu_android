...
public class ReminderDataFromServerDatabase extends SQLiteOpenHelper {
    ...
    public static final String COL_15 = "set_time";
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        sqLiteDatabase.execSQL("create table " + TABLE_NAME +" (ID INTEGER PRIMARY KEY AUTOINCREMENT,medicine_name TEXT," +
                ...
                "start_date TEXT,end_date TEXT,duration TEXT,set_time TEXT)");
    }
    ...
    public boolean insertTime(String setTheTime) {
        ...
        contentValues2.put(COL_15,setTheTime);

        long result2 = db2.insert(TABLE_NAME,null ,contentValues2);
        if(result2 == -1)
            return false;
        else
            return true;
