...
public class OrderReview extends AppCompatActivity {
    ...
    private String u_id, order_id, check_pincode_Second, check_pincode_first, add_zip, aId, note, sing_zip_code, sing_phone, sing_lanmark,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        order_id = passDataFromDeliveryPage.getStringExtra("order_id");
                        ...
                        new Response.Listener<String>() {
                            ...
                            public void onResponse(String response) {
                                ...
                                try {
                                    ...
                                    // Toast.makeText(OrderReview.this, response, Toast.LENGTH_LONG).show();
                        ...
                        try {
                            ...
                            if (status.equals("1")) {
                                ...
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    String instant_price = serch.getString("instant_price");
                        ...
                        try {
                            ...
                            if (status.equals("1")) {
                                ...
                                try {
                                    ...
                                    estimated_date.setText(newFormat);
                                } catch (Exception e) {
                                    e.printStackTrace();
