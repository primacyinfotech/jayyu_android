...
public class ManageAddAddressActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               /* Intent gotoLocationAddress = new Intent(ManageAddAddressActivity.this, ManagaAddressView.class);
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mob_num.length() < 13) {
                    Toast.makeText(ManageAddAddressActivity.this, "Invalid Mobile Number!", Toast.LENGTH_SHORT).show();
                } else if (pin_no.length() < 6) {
                    Toast.makeText(ManageAddAddressActivity.this, "Invalid Pincode!", Toast.LENGTH_SHORT).show();
                } else if (l_mark.length() < 2) {
                    Toast.makeText(ManageAddAddressActivity.this, "Invalid Landmark!", Toast.LENGTH_SHORT).show();
                } else if (addr.length() < 2)
                    Toast.makeText(ManageAddAddressActivity.this, "Invalid Address!", Toast.LENGTH_SHORT).show();
                else {
                    RequestQueue requestQueue = Volley.newRequestQueue(ManageAddAddressActivity.this);
