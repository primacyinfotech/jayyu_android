...
public class PatientPastPrescrptionAdapter extends RecyclerView.Adapter<PatientPastPrescrptionAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull PatientPastPrescrptionAdapter.MyViewHolder holder, final int position) {
        ...
        Picasso.with(context).load(BaseUrl.imageUrl + patientPastPrescriptionModel.getPast_pres_img()).into(holder.pres_display);
        holder.pres_display.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Picasso.with(context)
                        .load(BaseUrl.imageUrl + patientPastPrescriptionModel.getPast_pres_img())
                        .into(imageView);
        ...
        holder.pres_del.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TextView tvHeading = settingsDialog.findViewById(R.id.tv_heading);
                tvHeading.setText("Delete Report ?");
                Button buttonOk = settingsDialog.findViewById(R.id.buttonOk);
                buttonOk.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
