...
public class NormalWalletAdapter extends RecyclerView.Adapter<NormalWalletAdapter.MyViewHolder> {
    ArrayList<NormalWalletModel> normalWalletModels;
    Context context;

    public NormalWalletAdapter(ArrayList<NormalWalletModel> normalWalletModels, Context context) {
    ...
    @NonNull
    @Override
    public NormalWalletAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
